...
<div className="flex flex-col items-center justify-center mb-8">
  <h1 className="text-center text-3xl font-bold mb-4">Phantom Agent Starter</h1>
  <p className="text-center text-lg mb-6">A modern chat agent built with Next.js and Solana integration, featuring authentication via Phantom and AI capabilities.</p>
  ...
  <div className="flex flex-col items-center">
    ...
    <a href="https://vimeo.com/1076325238" className="text-blue-600 hover:underline">Watch demo video</a>
  </div>
</div>
