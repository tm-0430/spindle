---
title: 'Privy Solana App Kit - React Native'
description: 'Mobile chat application for Solana blockchain interaction with React Native and Privy'
icon: 'mobile'
---

<div className="flex flex-col items-center justify-center mb-8">
  <h1 className="text-center text-3xl font-bold mb-4">Privy Solana App Kit - React Native</h1>
  <p className="text-center text-lg mb-6">A mobile chat application that enables interaction with Solana blockchain through natural language conversation. Built with React Native, Expo, and integrated with AI for Solana transaction capabilities.</p>
  ...
  <div className="flex flex-col items-center">
    ...
    <a href="https://vimeo.com/1076322377" className="text-blue-600 hover:underline">Watch demo video</a>
  </div>
</div>
