---
title: 'Sanctum Finance'
description: 'Learn how to interact with Sanctum Finance for LST (Liquid Staking Token) operations'
---

Interact with Sanctum Finance to manage Liquid Staking Tokens (LSTs) on Solana. Sanctum provides a unified liquidity layer for LSTs, allowing users to add liquidity, swap between different LSTs, and access information about APYs, prices, and TVL.
