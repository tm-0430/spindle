...
export async function POST(req: NextRequest) {
  try {
    ...
    const rawVercelTools = createVercelAITools(solanaAgentWithPara, solanaAgentWithPara.actions);
    ...
    const result = await streamText({
      model: openai("meta-llama/llama-4-maverick-17b-128e-instruct") as LanguageModelV1,
      tools:tools as any,
      system: `
