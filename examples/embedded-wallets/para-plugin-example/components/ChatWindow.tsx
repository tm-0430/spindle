          ...
          message.toolInvocations.map(async (invocation: ToolInvocation) => {
            if (invocation.toolName === 'GET_ALL_WALLETS') {
              try {
                ...
                const wallets = await solanaAgentWithPara.methods.getParaInstance().getWallets();
                return {
                  ...invocation,
            ...
            try {
              const claim = await solanaAgentWithPara.methods.claimParaPregenWallet(invocation.args?.userShare as string,"");
              return {
                ...invocation,
